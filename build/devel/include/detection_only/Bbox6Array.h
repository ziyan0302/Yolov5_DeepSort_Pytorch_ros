...
#include <detection_only/Image.h>
...
struct Bbox6Array_
{
  ...
  (void)_alloc;
   ...
   typedef  ::detection_only::Image_<ContainerAllocator>  _image_type;
  _image_type image;
...
struct MD5Sum< ::detection_only::Bbox6Array_<ContainerAllocator> >
{
  ...
  static const uint64_t static_value1 = 0xd023923a68c57000ULL;
  static const uint64_t static_value2 = 0xf2065e0f664c2a6dULL;
};
...
struct Printer< ::detection_only::Bbox6Array_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::detection_only::Bbox6Array_<ContainerAllocator>& v)
  {
    s << indent << "image: ";
    s << std::endl;
    Printer< ::detection_only::Image_<ContainerAllocator> >::stream(s, indent + "  ", v.image);
